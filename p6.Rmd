...
Using these values in the dbinom function in R gives us:  P(X = 5) = `r dbinom(5, 10, 0.08)`
...
Using these values in the dbinom function in R gives us:  P(X = 5) = `r dbinom(5, 10, 0.30)`
